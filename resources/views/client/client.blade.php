...
@section('content')
    ...
    <div class="container">
        ...
        <h4>Happy Client Create | <a class="btn btn-sm btn-success pull-left" href="{{url('admin/happy-client')}}">View All</a></h4>
        <div class="mycard">
            <form action="{{ url('admin/storeclient') }}" method="post" id="createpost" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <button type="button" onclick="enterthis();" class="btn btn-primary btn-block">Add Client
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <main class="page">
                        <div class="box">
                            <div class="input-group">
                                ...
                                <input type="file" id="file-input" class="form-control" name="file+"
                                       onchange="ChangeSetImage(this, image_frout, file_text_frount);"> {{-- <input type="text" id="file_text_frount" class="form-control" readonly=""> --}}
                            </div>
