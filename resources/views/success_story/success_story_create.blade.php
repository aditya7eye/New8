...
<div class="container">
    ...
    <h4>Create Success Story <a class="btn btn-success pull-right" href="{{url('admin/success_story')}}">Story List</a> </h4>
    <hr>
    <div class="mycard">
        <form action="{{ url('admin/store_success_story') }}" method="post" id="createpost" enctype="multipart/form-data">
            @csrf
            <div class="row">
                {{-- <div class="col-sm-6">
