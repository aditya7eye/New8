...
<div class="container">
    ...
    <hr>
    <div class="mycard">
        <form action="{{ url('admin/update-success_story') }}" method="post" id="createpost" enctype="multipart/form-data">
            @csrf
            <div class="row">
                {{-- <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" placeholder="Enter Title" value="{{ $data->title }}"
                               class="form-control">
                        </select>
                    </div>
                </div>
