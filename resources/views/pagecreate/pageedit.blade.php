            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea id="editor1" name="des" class="form-control" rows="5">{{ $data->description }}</textarea>
            ...
            <div class="col-sm-12">
                <div class="upload_image_box">
                    ...
                    <div class="btn-group" data-toggle="modal" data-target="#modal_crop">
                        ...
                        <img style="height:300px; width:auto;" src="{{ url('dynamic_page_image').'/'.$data->image }}" alt="" id="myresultimage">
                    </div>
                    <!-- <input type="file" name="profile_pic" id="recend_select_file" class="profile-upload-pic"
                            onchange="ChangeSetImage(this, _UserProfile);"/>-->
                </div>
