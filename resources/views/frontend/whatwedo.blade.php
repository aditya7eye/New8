                ...
                @foreach ($whatwedo as $object)
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-service">
                            ...
                            <div class="single-service-icon"><img style="height: 40px;"
                                                                  src="{{ url('whatwedo').'/'.$object->image }}" alt="">
                            </div>

                            <h6>{{ $object->heading }}</h6>

                            <a href="#{{ $object->id  }}"
                               class="btn2 btngray btn--border btn--center btn--border-lightgrey page-scroll"> <span
                                        class="btn-text">Read More</span> <span class="btn-arrow"> <i
