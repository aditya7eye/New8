...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('admin/dashboard')}}">
            ...
            <div class="sidebar-brand-text mx-3">Alliance Admin</div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('admin/slider-menu') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>Slider</span></a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('admin/what-we-do') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('admin/header-manage') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('admin/success_story') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>Success Stories</span></a>
        </li>
        <li class="nav-item active">
            <a class="nav-link" href="{{ url('admin/success_year') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>Success Years</span></a>
        </li>
        <li class="nav-item active">
